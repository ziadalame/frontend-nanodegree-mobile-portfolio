...
function logAverageFrame(times) {   // times is the array of User Timing measurements from updatePositions()
	...
	var sum = 0;
	// convert to total 60 frames to see total time
...
document.addEventListener('DOMContentLoaded', function () {
	var cols = 8;
	var s = 256;
	// Calculate the exact number of pizzas required instead of 200
	var totalPizzas = Math.ceil(cols * screen.availHeight / s);
